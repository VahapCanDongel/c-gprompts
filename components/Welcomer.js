...
export default function Welcomer() {
  ...
  return (
    <div className="w-full h-screen text-white flex justify-center items-center z-50 inset-0 ">
      {showComponent && (
        <div>
          <div className="flex justify-center items-center animate-bounce transition-all ease-in-out">
            <div className="flex flex-col">
              ...
              <p className="w-[280px] m-5 text-[20px]">
                This is a Chat GPT prompt stock website. This webiste is
                currently mainly used to store prompts that can be beneficial
                for educators.
              </p>
            </div>
          ...
          {/* This is the pogress bar */}
          <div className="h-1 w-[400px] bg-neutral-200 dark:bg-neutral-600 m-4">
            <div
              className="h-full bg-gradient-to-r from-rose-500 to-indigo-700"
